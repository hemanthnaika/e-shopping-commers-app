...
export const CartOrderSummary = ({ total }) => {
    ...
    const handleOrder = async () => {
        ...
        const result = await axios.post(" https://hemanth-e-commerce-backend-api.herokuapp.com/api/v1/order/createOrder", {
            amount: total1
        ...
        const options = {
            key: "rzp_test_mnpasfjLtI4FC1", // Enter the Key ID generated from the Dashboard
            ...
            handler: async function (response) {
                ...
                const result = await axios.post(" https://hemanth-e-commerce-backend-api.herokuapp.com/api/v1/order/verify", data);

                alert(result.data.msg);
            },
            prefill: {
                name: "Hemanth",
                email: "hemanth2002@gmail.com",
                contact: "9999999999",
            },
            notes: {
                address: "Camp road",
